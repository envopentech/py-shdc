...
class SHDCCrypto:
    ...
    @staticmethod
    def encrypt_aes_gcm(key: bytes, plaintext: bytes, nonce: Optional[bytes] = None,
    ...
    @staticmethod
    def derive_session_key(shared_secret: bytes, device_id_a: int, device_id_b: int) -> bytes:
        """
    ...
    @staticmethod
    def hash_device_fingerprint(device_id: int, public_key: bytes, device_type: str) -> bytes:
        """
