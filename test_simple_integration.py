...
class SimpleIntegrationTest:
    ...
    async def test_component_creation(self):
        ...
        try:
            ...
            hub_protocol = SHDCProtocol(DeviceRole.HUB, device_id=0x12345678, port=56700)
            sensor_protocol = SHDCProtocol(DeviceRole.SENSOR, device_id=0x87654321, port=56701)
            ...
            nonce, encrypted = crypto.encrypt_aes_gcm(b"0" * 32, plaintext)  # 32-byte key
